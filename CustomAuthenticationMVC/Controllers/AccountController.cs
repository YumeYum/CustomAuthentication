...
namespace CustomAuthenticationMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginView loginView, string ReturnUrl = "")
        {
            ...
            ModelState.AddModelError("", "Contraseña o Usuario incorrectos");
        ...
        public ActionResult Registration(RegistrationView registrationView)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Warning Email", "El Email ya existe");
            ...
            {
                messageRegistration = "¡Algo anduvo mal!";
            }
        ...
        public ActionResult ActivationAccount(string id)
        {
            ...
            using (AuthenticationDB dbContext = new DataAccess.AuthenticationDB())
            {
                ...
                {
                    ViewBag.Message = "¡Algo anduvo mal!";
                }
        ...
        public void VerificationEmail(string email, string activationCode)
        {
            ...
            var fromEmail = new MailAddress("memoria002@gmail.com", "Activación de Cuenta");
            var toEmail = new MailAddress(email);

            var fromEmailPassword = "slayersdesign1";
            string subject = "Activación de cuenta";

            string body = "<br/> Siga el link a continuación para activar su cuenta:" + "<br/><a href='" + link + "'> Activación de cuenta ! </a>";
